...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Close
    ref={ref}
    className={cn(
      "mt-2 inline-flex items-center justify-center rounded-md bg-secondary px-4 py-2",
      "text-sm font-medium text-secondary-foreground transition-colors hover:bg-secondary/80 focus-visible:outline-none",
      "focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 sm:mt-0",
      className
    )}
    {...props}
  />
