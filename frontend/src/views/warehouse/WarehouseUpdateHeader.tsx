...
interface WarehouseUpdateHeaderProps {
  code: string;
}

export default function WarehouseUpdateHeader({
  code,
}: WarehouseUpdateHeaderProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:flex md:flex-row md:justify-between md:items-center items-center gap-4 pb-4">
      <div className="grid grid-cols-2 items-center gap-4 md:inline-flex w-auto">
        <h1 className="text-lg font-semibold">{`ACTUALIZAR BODEGA - ${code}`}</h1>
      </div>
