...
interface BusinessUpdateHeaderProps {
  document: string;
}

export default function BusinessUpdateHeader({
  document,
}: BusinessUpdateHeaderProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:flex md:flex-row md:justify-between md:items-center items-center gap-4 pb-4">
      <div className="grid grid-cols-2 items-center gap-4 md:inline-flex w-auto">
        <h1 className="text-lg font-semibold">{`ACTUALIZAR EMPRESA - ${document}`}</h1>
      </div>
