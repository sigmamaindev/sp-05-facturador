...
import type { Customer, UpdateCustomerForm } from "@/types/customer.types";
...
export default function CustomerUpdateForm({
  ...
  const onSubmit: SubmitHandler<UpdateCustomerForm> = async (data) => {
    try {
      setSavingCustomer(true);

      const response = await updateCustomer(customer.id, data, token!);
